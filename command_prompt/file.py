...
def main():
    ...
    window.print('\ahttps://www.youtube.com\aClick to go to youtube!\a')
    # # window.print('\n\033[38;2;255;255;255m\033[2mHello\033[0m\033[38;2;128;128;128mHello\033[m')
    # window.print('\033[5mHello\033[m\n')
    # window.print('\033[6mHello\033[m')
